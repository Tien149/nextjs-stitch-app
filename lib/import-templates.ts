...
export const importTemplates: ImportTemplateDefinition[] = [
  ...
  },
  {
    ...
    description: "Template lương gom theo cửa hàng và bộ phận (không khai từng nhân viên): TỔNG CHI PHÍ CÔNG TY lên chi phí nhân sự, LƯƠNG THỰC NHẬN thành công nợ phải trả người lao động.",
    fields: [
      { field: "period", label: "Kỳ lương", required: true, type: "text", aliases: ["ky luong", "ky", "period", "payroll period"] },
      { field: "branch_code", label: "Cửa hàng", required: true, type: "text", aliases: ["chi nhanh", "branch", "store"] },
      { field: "department_code", label: "Phòng ban", required: true, type: "text", aliases: ["phong ban", "bo phan", "department"] },
      ...
      { field: "company_insurance", label: "Bảo hiểm (công ty chịu)", required: false, type: "number", aliases: ["bao hiem (cong ty chiu)", "bao hiem cong ty chiu", "bao hiem cty chiu", "bao hiem"] },
      {
        ...
        note: "Bằng tổng bảy cột từ TỔNG LƯƠNG THEO GIỜ CÔNG đến Bảo hiểm (công ty chịu). Đây là số lên chi phí nhân sự trên P&L",
      },
      {
        field: "net_amount",
        ...
        note: "Tiền thực đưa người lao động. Import xong sẽ thành công nợ phải trả cho bộ phận này",
      },
      { field: "external_ref", label: "Mã tham chiếu", required: false, type: "text", aliases: ["ma tham chieu", "reference", "external ref"] },
    ],
  },
