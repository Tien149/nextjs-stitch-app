...
saveWorkbook("mau_so_du_dau_ky.xlsx", [
  ["Ky", "Chi nhanh", "Loai so du", "Ma doi tuong", "Ten doi tuong", "Nguon tien", "Kho", "Phong ban", "So luong", "Don gia", "So ky phan bo", "Ky bat dau phan bo", "Hang muc P&L", "So tien", "Ghi chu"],
  ...
  // Hạng mục P&L khai ngay trên file: khoản phân bổ sinh ra khi commit mang luôn mã này.
  ["2026-07", "HCM", "PREPAID_EXPENSE", "PB001", "Chi phi phan bo dau ky", "OPEX_RENT", "", "", "", "", 12, "2026-07", "PNL_THUE_MB", 120000000, "Chi phi phan bo dau ky"],
]);
