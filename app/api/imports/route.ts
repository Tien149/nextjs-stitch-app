...
function templateExampleRows(templateCode: string): Array<Record<string, string | number | Date>> {
  if (templateCode === "BANK_STATEMENT_STANDARD_V1") {
    ...
    return [
      { transaction_date: new Date("2026-07-01T00:00:00Z"), bank_account: "VCB_HCM", transaction_code: "VCB2607010001", description: "POS HCM ngay 01/07 - doanh thu the tai quay", credit_amount: 12850000, balance_after: 2512850000, branch_code: "HCM", partner_hint: "POS_HCM", category_code: "THU_BAN_HANG", source_date: new Date("2026-07-01T00:00:00Z"), revenue_date: new Date("2026-06-30T00:00:00Z"), summary_money_source_code: "VCB_HCM", increase_money_source_code: "VCB_HCM", decrease_money_source_code: "VI_POS_HCM", operation_type: "WALLET_SETTLEMENT", gross_amount: 12850000, grab_expense_amount: 0, card_fee_amount: 0 },
