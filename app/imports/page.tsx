...
const importTabs: ImportTab[] = [
  ...
  },
  {
    ...
    primaryFields: ["code", "name", "item_type", "unit", "purchase_unit", "conversion_rate", "min_stock"],
  },
  {
    ...
    primaryFields: ["transaction_date", "transaction_type", "branch_code", "warehouse_code", "to_warehouse_code", "item_code", "quantity", "unit_code", "unit_cost", "reference_code"],
  },
  {
    id: "bom",
    ...
    primaryFields: ["product_code", "product_name", "ingredient_code", "quantity", "waste_rate", "effective_date"],
  },
  {
    id: "stocktake",
    label: "Kiem ke kho",
    ...
    subtitle: "Nhap ton thuc te theo cua hang/kho de he thong sinh dieu chinh kiem ke.",
    ...
    primaryFields: ["stocktake_date", "branch_code", "warehouse_code", "item_code", "actual_quantity", "reason"],
  },
  {
    id: "opening-balance",
    label: "Số dư đầu kỳ",
